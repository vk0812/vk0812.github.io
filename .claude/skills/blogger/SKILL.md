...
6. Grep the file for stray `:`, `;`, `—`, `–` in prose one more time (see Punctuation rule above), it's cheap and catches anything a mid-edit slipped in.
7. Send the user the local URL.
8. **Don't commit.** Leave commits to the user unless they explicitly ask.
