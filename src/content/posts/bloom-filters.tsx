...
export const bloomFilters: BlogPostData = {
  ...
  content: (
    <>
      ...
      <BitArrayDiagram
        delay={0.1}
        caption="A 10-bit array with 3 hash functions. Inserting &quot;milk&quot; sets three bits, querying &quot;milk&quot; again finds them all set, and querying &quot;proxy&quot; hits an unset bit and rules it out immediately."
      />
