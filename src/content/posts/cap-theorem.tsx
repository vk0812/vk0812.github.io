...
export const capTheorem: BlogPostData = {
  ...
  content: (
    <>
      ...
      <CapTriangleDiagram
        delay={0.05}
        caption="The CAP triangle. Partition tolerance is assumed for any real distributed system, so a partition forces the choice between consistency and availability."
      />
      ...
      <ReplicationDiagram
        ...
        panels={[
          {
            title: "CP system during a partition",
            writeLabel: "Client request arrives",
            fanLabel: "quorum required to answer",
            nodes: ["Node A (majority)", "Node B (minority)"],
            highlightNodes: [0],
            note: "Node B refuses the request since it has no quorum. Node A keeps serving.",
          },
          {
            title: "AP system during a partition",
            writeLabel: "Client request arrives",
            fanLabel: "every node keeps answering",
            nodes: ["Node A", "Node B"],
            highlightNodes: [0, 1],
            note: "Both nodes answer independently and reconcile once the partition heals.",
          },
        ]}
      />
