        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          >
            <p className="text-foreground font-sans leading-relaxed text-justify mb-8">
              I enjoy shipping real things that work, exploring the boundaries of ML systems, and 
              occasionally making AI models question their life choices. Always up for learning, 
              building, or geeking out over obscure bugs and good API design.
            </p>
            ...
            <p className="text-foreground font-sans leading-relaxed text-justify mb-8">
              I was also the Institute System Administrator at IIT Bombay, helping maintain critical 
              infrastructure for 20,000+ users and coordinating a campus-wide tech committee.
            </p>
