...
const WhoAreYou = () => {
  ...
  return (
    <section id="about" className="py-16 sm:py-20 lg:py-24 px-5 sm:px-6 bg-card">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-16">
          ...
          <motion.div
            ...
            className="lg:col-span-1 lg:order-1 order-1"
          >
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-medium text-foreground mb-5 sm:mb-7 lg:mb-8">
              <span className="italic text-4xl sm:text-5xl md:text-6xl">W</span>ho Am I?
            </h2>

            <div className="text-foreground font-sans leading-relaxed text-left lg:text-justify mb-6 sm:mb-8 text-sm sm:text-base">
              {bioText}
            </div>
          ...
          >
            <p className="text-foreground font-sans leading-relaxed text-left lg:text-justify mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="font-sans font-medium text-foreground mb-3 sm:mb-4">Cycle of my Creation</h3>
              <div className="bg-muted rounded-lg p-3 sm:p-4">
                <p className="font-sans text-foreground text-sm sm:text-base flex flex-wrap items-center gap-x-1 gap-y-1">
            ...
            <div className="text-left lg:text-right">
              ...
              <div className="flex justify-start lg:justify-end gap-5 sm:gap-6">
                <motion.a
