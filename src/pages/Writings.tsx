...
const blogPosts: BlogPost[] = [
  ...
  { id: "normalization-residual-connections-modern-blocks", title: "Normalization, Residual Connections, and Modern Blocks", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "loss-functions-objective-design", title: "Loss Functions and Objective Design", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "neural-networks-backpropagation-from-scratch", title: "Neural Networks and Backpropagation from Scratch", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "recurrent-networks-sequence-modeling", title: "Recurrent Networks and Sequence Modeling", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "regularizing-deep-networks", title: "Regularizing Deep Networks", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "optimizers-learning-rate-schedules", title: "Optimizers and Learning-Rate Schedules", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "model-interpretability-explainability", title: "Model Interpretability and Explainability", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "classification-metrics-decision-thresholds", title: "Classification Metrics and Decision Thresholds", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "cross-validation-hyperparameter-optimization", title: "Cross-Validation and Hyperparameter Optimization", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "regression-ranking-retrieval-forecasting-metrics", title: "Regression, Ranking, Retrieval, and Forecasting Metrics", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "dimensionality-reduction-manifold-learning", title: "Dimensionality Reduction and Manifold Learning", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "svm-kernel-methods", title: "Support Vector Machines and Kernel Methods", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "clustering", title: "Clustering", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "nearest-neighbors-instance-based-learning", title: "Nearest Neighbors and Instance-Based Learning", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "gradient-boosted-decision-trees", title: "Gradient-Boosted Decision Trees", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "logistic-regression-glm", title: "Logistic Regression and Generalized Linear Models", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "bagging-random-forests", title: "Bagging and Random Forests", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "regularized-linear-models", title: "Regularized Linear Models", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "learning-to-rank", title: "Learning to Rank", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "decision-trees", title: "Decision Trees", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "naive-bayes-probabilistic-classifiers", title: "Naive Bayes and Probabilistic Classifiers", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "linear-regression-first-principles", title: "Linear Regression from First Principles", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "generalization-bias-variance", title: "Generalization and the Bias-Variance Trade-off", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "optimization-fundamentals", title: "Optimization Fundamentals", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "information-theory-for-ml", title: "Information Theory for ML", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "statistics-estimation-uncertainty", title: "Statistics, Estimation, and Uncertainty", date: "01/08", tag: "Machine Learning", year: 2026 },
  { id: "probability-for-machine-learning", title: "Probability for Machine Learning", date: "29/07", tag: "Machine Learning", year: 2026 },
  { id: "designing-google-docs", title: "Designing Google Docs", date: "07/08", tag: "Case Studies", year: 2026 },
  { id: "designing-web-crawler", title: "Designing a Web Crawler", date: "06/08", tag: "Case Studies", year: 2026 },
  { id: "designing-payment-system", title: "Designing a Payment System", date: "05/08", tag: "Case Studies", year: 2026 },
  { id: "designing-ad-click-aggregator", title: "Designing an Ad Click Aggregator", date: "04/08", tag: "Case Studies", year: 2026 },
  { id: "designing-metrics-monitoring", title: "Designing a Metrics Monitoring Platform", date: "03/08", tag: "Case Studies", year: 2026 },
  { id: "designing-job-scheduler", title: "Designing a Distributed Job Scheduler", date: "02/08", tag: "Case Studies", year: 2026 },
  { id: "designing-chatgpt", title: "Designing ChatGPT", date: "01/08", tag: "Case Studies", year: 2026 },
  { id: "designing-notification-system", title: "Designing a Notification System", date: "31/07", tag: "Case Studies", year: 2026 },
  { id: "designing-ticketmaster", title: "Designing Ticketmaster", date: "13/07", tag: "Case Studies", year: 2026 },
  { id: "designing-uber", title: "Designing Uber", date: "12/07", tag: "Case Studies", year: 2026 },
  { id: "designing-yelp", title: "Designing Yelp", date: "12/07", tag: "Case Studies", year: 2026 },
